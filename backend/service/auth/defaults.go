...
var (
	DefaultRole = []model.AuthRole{
		{RoleCode: "Admin", RoleName: "admin_role", MaxVolCount: -1, MaxVolSize: -1},
		{RoleCode: "Operator", RoleName: "operator_role", MaxVolCount: -1, MaxVolSize: -1},
		{RoleCode: "Viewer", RoleName: "viewer_role", MaxVolCount: 1, MaxVolSize: 2},
	}
