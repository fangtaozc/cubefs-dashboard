...
func List(c *gin.Context) {
	...
	data, err := syncservice.ListRules(c, input.State)
	if err != nil {
...
func Get(c *gin.Context) {
	...
	data, err := syncservice.GetRule(c, input.Id)
	if err != nil {
		syncservice.SendError(c, err)
		return
	}
...
func Create(c *gin.Context) {
	...
	data, err := syncservice.CreateRule(c, input)
	if err != nil {
		syncservice.SendError(c, err)
		return
	}
...
func Update(c *gin.Context) {
	...
	data, err := syncservice.UpdateRule(c, input)
	if err != nil {
		syncservice.SendError(c, err)
		return
	}
...
func Delete(c *gin.Context) {
	...
	data, err := syncservice.DeleteRule(c, input.Id)
	if err != nil {
		syncservice.SendError(c, err)
		return
	}
...
func Pause(c *gin.Context) {
	...
	data, err := syncservice.PauseRule(c, input.Id)
	if err != nil {
		syncservice.SendError(c, err)
		return
	}
...
func Resume(c *gin.Context) {
	...
	data, err := syncservice.ResumeRule(c, input.Id)
	if err != nil {
		syncservice.SendError(c, err)
		return
	}
...
func Trigger(c *gin.Context) {
	...
	data, err := syncservice.TriggerRule(c, input.Id)
	if err != nil {
		syncservice.SendError(c, err)
		return
	}
...
func parseRuleConfig(c *gin.Context) (map[string]interface{}, bool) {
	...
	if len(input) == 0 {
		ginutils.Send(c, codes.InvalidArgs.Code(), "sync rule config is empty", nil)
		return nil, false
	}
	return input, true
}
