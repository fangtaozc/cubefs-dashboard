...
export default {
  ...
  router: {
    ...
    syncmanage: 'Sync',
    testmanage: 'Test',
    posixcompliance: 'POSIX Compliance',
  ...
  sync: {
    ...
    avgloadscore: 'Avg load score',
    basicinfo: 'Basic info',
    boltdbhealthy: 'BoltDB health',
    buildtime: 'Build time',
    canceltask: 'Cancel task',
    concurrenttasks: 'Concurrent tasks',
    confirmdrain: 'This clears current node tasks but keeps the node registration so it can be restored later.',
    confirmforcedecommission: 'This interrupts or clears current node tasks and removes the node record.',
    confirmsmoothdecommission: 'This only stops new dispatches. Running tasks finish naturally and the node is removed afterwards.',
    confirmrestore: 'This restores the node from draining back to active.',
    cpupercent: 'CPU usage',
    createdat: 'Created at',
    currenttasks: 'Current task summary',
    dispatchtask: 'Create task',
    dispatchtips: 'Direct /syncNode/dispatch is supported. Request should at least include taskId and ruleId; add shardTotal for fan-out when needed.',
    diagnostics: 'Diagnostics',
    doneat: 'Done at',
    drain: 'Enter maintenance',
    entermaintenance: 'Worker maintenance',
    ...
    maxconcurrenttasks: 'Concurrency cap',
    owner: 'Owner',
    parallelism: 'Parallelism',
    progress: 'Progress',
    queuedtasks: 'Queued tasks',
    reload: 'Reload',
    reloadfailures: 'Reload failures',
    reloadtips: 'Reload only applies non-rule config. Rules are owned by the master.',
    restore: 'Restore service',
    retrytask: 'Retry task',
    ruleconfig: 'Rule JSON',
    rules: 'Rules',
    runningtasks: 'Running tasks',
    scheduledrulestips: 'scheduledRules is always 0 after P2.',
    schedule: 'Schedule',
    shardidx: 'Shard index',
    shardstrategy: 'Sharding strategy',
    shardtotal: 'Shard total',
    smoothoffline: 'Graceful offline',
    startedat: 'Started at',
    state: 'State',
    stat: 'Runtime snapshot',
    tasks: 'Tasks',
    taskerror: 'Error',
    taskpayload: 'Task request JSON',
    taskfailurerate: 'Task failure rate',
    ...
    backendinsecuretls: 'Skip TLS verify',
    backendremark: 'Remark',
    createbackend: 'Create Backend',
    editbackend: 'Edit Backend',
    deletebackend: 'Delete',
    confirmdeletebackend: 'Confirm delete this storage backend?',
    akmasked: 'Access Key (masked)',
    keepsecretkey: 'Leave empty to keep current Secret Key',
    keepaccesskey: 'Leave empty to keep current Access Key',
  },
  bench: {
    rules: 'Bench Rules',
    tasks: 'Bench Tasks',
    ...
    fiodefaults: 'FIO Defaults',
    fiostages: 'FIO Stages',
    createbenchrule: 'Create Bench Rule',
    editbenchrule: 'Edit Bench Rule',
    deletebenchrule: 'Delete',
    confirmdeletebenchrule: 'Confirm delete this bench rule?',
    trigger: 'Trigger',
    triggerbenchrule: 'Trigger Bench Task',
    taskid: 'Task ID',
    taskstatus: 'Status',
    shardidx: 'Shard Index',
    nodeaddr: 'Node Addr',
    throughput: 'Throughput (MB/s)',
    iops: 'IOPS',
    latencyp50: 'P50 Latency (μs)',
    latencyp99: 'P99 Latency (μs)',
  ...
  volume: {
    ...
    authorizationorattributionexists: 'The user has volume ownership or access authorization, and needs to transfer ownership and clear authorization',
  },
  tenant: {
  ...
  cfsclusteroverview: {
    ...
    keepsyncadmintoken: 'Leave empty to keep the current sync admin token',
    inputsyncadmintoken: 'Enter sync admin token',
    inputsyncnodeport: 'Enter syncnode admin port',
    syncadmintoken: 'sync admin token',
    syncnodeport: 'syncnode admin port',
    tag: 'Tag',
  ...
  privileges: {
    ...
    CFS_SYNCNODE_DECOMMISSION: 'worker decommission',
    CFS_SYNCNODE_DISPATCH: 'worker dispatch task',
    CFS_SYNCNODE_DRAIN: 'worker drain',
    CFS_SYNCNODE_LIST: 'worker list',
    CFS_SYNCNODE_RELOAD: 'worker reload',
    CFS_SYNCNODE_RESTORE: 'worker restore',
    CFS_SYNCNODE_STAT: 'worker stat',
    CFS_SYNCNODE_TASKS: 'worker tasks',
    CFS_SYNCNODE_VERSION: 'worker version',
    CFS_SYNCRULE_CREATE: 'create sync rule',
    CFS_SYNCRULE_DELETE: 'delete sync rule',
    CFS_SYNCRULE_GET: 'get sync rule',
    CFS_SYNCRULE_LIST: 'sync rules',
    CFS_SYNCRULE_PAUSE: 'pause sync rule',
    CFS_SYNCRULE_RESUME: 'resume sync rule',
    CFS_SYNCRULE_TRIGGER: 'trigger sync rule',
    CFS_SYNCRULE_UPDATE: 'update sync rule',
    CFS_SYNCTASK_CANCEL: 'cancel sync task',
    CFS_SYNCTASK_EXPORT: 'export sync tasks',
    CFS_SYNCTASK_GET: 'get sync task',
    CFS_SYNCTASK_LIST: 'sync tasks',
    CFS_SYNCTASK_RETRY: 'retry sync task',
    CFS_SYNCBACKEND_LIST: 'storage backends',
    CFS_SYNCBACKEND_CREATE: 'create storage backend',
    CFS_SYNCBACKEND_UPDATE: 'update storage backend',
    CFS_SYNCBACKEND_DELETE: 'delete storage backend',
    CFS_SYNCBACKEND_CONFIG: 'get storage backend config',
    CFS_BENCHRULE_LIST: 'bench rules',
    CFS_BENCHRULE_CREATE: 'create bench rule',
    CFS_BENCHRULE_UPDATE: 'update bench rule',
    CFS_BENCHRULE_DELETE: 'delete bench rule',
    CFS_BENCHTASK_LIST: 'bench tasks',
    CFS_BENCHTASK_GET: 'get bench task',
    CFS_BENCHTASK_CANCEL: 'cancel bench task',
    CFS_BENCHTASK_RETRY: 'retry bench task',
    CFS_BENCHTASK_TRIGGER: 'trigger bench task',
